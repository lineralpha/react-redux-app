import { Button, Container, Divider, Grid, Image, Header, Segment } from "semantic-ui-react";

const HomeContent = () => {
    return (
        <>
            <Segment id="overview" style={{ padding: "8em 0em" }} vertical>
            ...
            <Segment id="testimony" style={{ padding: "0em" }} vertical>
